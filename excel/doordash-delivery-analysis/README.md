...
As an optional LevelUp analysis, I created a PivotTable comparing average delivery time across cuisine categories and sorted the results from longest to shortest delivery time.
